...
using InteractionFlow.Samples.HelloDoor.Lock.Externals.Operations;
using InteractionFlow.Samples.HelloDoor.Lock.Externals.Reactions;
...
namespace InteractionFlow.Samples.HelloDoor.Lock
{
    internal static class Program
    {
        private static async Task Main()
        {
            ...
            builder
                ...
                .UseFunction<IDoorOperation, ConsoleLockDoorOperation>()
                .UseFunction<IDoorReaction, ConsoleLockDoorReaction>()
            ...
            using var context = new ScopedFlowContext(new FlowContext())
                ...
                .With(new DoorLockState { IsLocked = true })
                .With(new RefEntry<DoorLockCommand>(DoorLockCommand.Unknown));

...
using InteractionFlow.Standard.Console.Externals.Operations;
using InteractionFlow.Standard.Console.Externals.Reactions;
using InteractionFlow.Standard.Console.Externals.SilentExternals;
using System;

namespace InteractionFlow.Standard.Console.Builders
{
    /// <summary>
